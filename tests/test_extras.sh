...
-q vector(1) -w 2 -c 3 -i #OK - tc is 1: {}
-q vector(2) -w 2 -c 3 -i #WARNING - tc is 2: {}
-q vector(3) -w 2 -c 3 -i #CRITICAL - tc is 3: {}
-q vector(4) -w 2 -c 3 -i #CRITICAL - tc is 4: {}
...
-q vector(1) -w 2 -c 3 -i -p #OK - tc is 1: {} | query_result=1
-q vector(2) -w 2 -c 3 -i -p #WARNING - tc is 2: {} | query_result=2
-q vector(3) -w 2 -c 3 -i -p #CRITICAL - tc is 3: {} | query_result=3
-q vector(4) -w 2 -c 3 -i -p #CRITICAL - tc is 4: {} | query_result=4
...
-q ${QUERY_VECTOR_UP} -w 2 -c 3 -i #OK - tc is 1: { __name__: up, instance: localhost:9090, job: prometheus }

# Scalar query on non-scalar and vice versa
# Vector autodetected
-q vector(1) -w 2 -c 3 #OK - tc is 1
-q vector(1) -w 2 -c 3 -t vector #UNKNOWN - deprecated argument provided: -t vector
-q vector(1) -w 2 -c 3 -t scalar #UNKNOWN - deprecated argument provided: -t scalar
# Scalar autodetected
-q 1 -w 2 -c 3 #OK - tc is 1
-q 1 -w 2 -c 3 -t vector #UNKNOWN - deprecated argument provided: -t vector
-q 1 -w 2 -c 3 -t scalar #UNKNOWN - deprecated argument provided: -t scalar
# Scalar autodetected
-q scalar(vector(1)) -w 2 -c 3 #OK - tc is 1
-q scalar(vector(1)) -w 2 -c 3 -t vector #UNKNOWN - deprecated argument provided: -t vector
